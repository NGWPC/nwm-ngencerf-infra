...
module "ngencerf" {
  ...
  ngencerf_server_image = "ghcr.io/ngwpc/ngencerf-server:20260821202953Z-development"
  ...
  sif_workloads = {
    "nwm-cal-mgr"  = "20260824173430Z-development"
    "nwm-fcst-mgr" = "20260821193356Z-development"
